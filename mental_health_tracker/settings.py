...
SECRET_KEY = "django-insecure-grj2x1u&vm(etm58il3xk=9lkj5@m#r(k8#nd4+!#w8po$2dky"
...
CSRF_TRUSTED_ORIGINS = ["http://localhost","http://127.0.0.1","http://muhammad.brian31/myhealthtracker.pbp.cs.ui.ac.id", "https://muhammad.brian31/myhealthtracker.pbp.cs.ui.ac.id"]
